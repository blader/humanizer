...
- **45 rules** at launch: 29 detection rules (Wikipedia) + 16 craft rules (Zinsser × 6, Strunk & White × 5, HBR Guide × 5)
...
- **Strunk & White**, *The Elements of Style* (4th ed., 1999) — 5 rules
